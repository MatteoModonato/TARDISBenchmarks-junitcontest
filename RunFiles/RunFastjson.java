...
public class RunFastjson {
	...
	public static final Path SUBJECT_ROOT          = Paths.get("/home", "ubuntu", "tardisFolder", "tardisExperiments", "bin", "TARDISBenchmarks-junitcontest", "fastjson");
	...
	public static void main(String[] s) throws IOException {
		...
		o.setClassesPath(SUBJECT_PATH, CXF_PATH, JERSEY_PATH, SPRING_PATH, ASM_PATH, JSON_SMART_PATH, EZMORPH_PATH, JAVASLANG_PATH, SLF4J_PATH, SPRINGTX_PATH, JUNIT_PATH, JSONLIB_PATH,
				STAX2_PATH, SPRING_SECWEB_PATH, JERSEY_CONTAINER_PATH, JERSEY_TEST_PATH, JAVAX_PATH, XMLSCHEMA_PATH, JAVAX_INJECT_PATH, AOPALLIANCER_PATH, COMMONS_PATH, JACKSON_PATH, SPRING_SECCORE_PATH,
				COMMONS_COLL_PATH, HIBERNATE_PATH, SPRING_WEB_PATH, COMMONS_IO_PATH, HK2_PATH, JCKSON_CORE_PATH, JETTY_PATH, JERSEY_MEDIA_PATH, SPRINGFOX_PATH, SPRING_WEBMVC_PATH, JSONITER_PATH,
				OKHTTP_PATH, ASMDEBUG_PATH, ASMCOMMON_PATH, WOODSTOX_PATH, CGLIB_PATH, JETTYC_PATH, JAVAXWS_PATH, JACKSON_ANNO_PATH, JAVASSIST_PATH, HAMCREST_CORE_PATH, SPRING_PLUGIN_PATH, CXF_CORE_PATH,
				HK2_API_PATH, JCL_PATH, CXFRT_PATH, JETTY_SERVLET_PATH, ANTLR_PATH, JERSEY_ENTITY_PATH, SPRING_TEST_PATH, JETTY_SECURITY_PATH, CLASSMATE_PATH, ANNOTATIONS_PATH, JBOSS_PATH, JACKSON_JAXRS_PATH,
				SPRING_DATA_PATH, SPRING_PLUGINC_PATH, ACCESSORS_PATH, GUAVA_PATH, COMMONS_LANG_PATH, JERSEY_SERVER_PATH, OSGI_PATH, JAVAX_SERVLET_PATH, JACKSON_MODULE_PATH, CXF_RT_PATH, JBOSS_TRANSAC_PATH,
				COMMONS_COLL4_PATH, RETROFIT_PATH, JERSEY_CS_PATH, HIBERNATE_JPA_PATH, HK2_LOCATOR_PATH, JANDEX_PATH, ASM_TREE_PATH, SPRING_OXM_PATH, JERSEY_CLIENT_PATH, CLOJURE_PATH, JACKSON_KOTLIN_PATH,
				SPRINGFOX_CORE_PATH, JETTY_HTTP_PATH, SPRINGFOX_WEB_PATH, JAVAS_LANG_PATH, DOM4J_PATH, JACKSON_DATA_PATH, VALIDATION_PATH, JETTY_UTIL_PATH, SPRING_DATAC_PATH, SPRING_AOP_PATH, KOTLIN_PATH,
				JETTY_SERVER_PATH, JERSEY_TESTF_PATH, SPRING_CONTEX_PATH, JAVAX_S_PATH, COMMONS_LOG_PATH, JERSEY_GUAVA_PATH, SPRING_BEANS_PATH, SPRING_DATACO_PATH, ASM_UTIL_PATH, ASM_ANALYSIS_PATH,
				JSON_SIMPLE_PATH, JETTY_XML_PATH, SPRING_EXP_PATH, JERSEY_COMMON_PATH, JACKSON_BASE_PATH, SPRING_CORE_PATH, JETTY_IO_PATH, HIBERNATEC_PATH, GROOVY_PATH, GSON_PATH, AOPALLIANCE_PATH,
				KOTLINR_PATH, SPRING_KEY_PATH, OKIO_PATH, JERSEYC_PATH, JSON_PATH, SPRING_W_PATH, COMMONS_LANG3_PATH);
